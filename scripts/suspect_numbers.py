    ...
    def construct_ranges(ranges):
        ...
        for i in range(0, len(ranges), 2):
            ...
            try:
                ...
                error_message(
                    "invalid ranges provided. Could not convert {} or {} to an integer type.".format(lower, upper))
...
def cli():
    ...
    group.add_argument('-r', '--ranges', action='store',
                       nargs='+', dest='ranges', help='List of ranges')
    group.add_argument('-c', '--csv_file', action='store',
                       help="path to CSV of ranges")
    group.add_argument('-e', '--excel_file', action='store',
                       help="path to excelsheet of ranges")

    ...
    def mgclchecker(self):
        ...
        for _, row in raw_data.iterrows():
            ...
            try:
                ...
                error_message(
                    "{}... failed to copy {}... skipping".format(
                        exception, old_location
                    ),
                    False,
                )
...
def cli():
    ...
    my_parser = argparse.ArgumentParser(
        description="Relocate troublesome images based on the log output of other scripts",
    ...
    my_parser.add_argument(
        "-l", "--log", required=True, type=str, help="path to the log file"
    )
    my_parser.add_argument(
        "-d", "--destination", required=True, type=str, help="path to the new directory"
    )
